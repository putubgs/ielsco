...
export const eventsData: EventData[] = [
  {
    ...
    description:
      "Join a transformative 8-week journey with IELS Circle, a dynamic and inclusive English learning community that brings together passionate individuals eager to grow in their language skills. Whether you're a beginner or looking to polish your English fluency, this program is designed to support your progress through consistent engagement, meaningful conversations, and collaborative activities.",
  ...
  },
  {
    ...
    registrationDateDeadline: "2025-10-19",
  },
];
