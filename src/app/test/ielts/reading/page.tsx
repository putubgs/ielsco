...
export default function ReadingPage() {
  ...
  const submit = () => {
    localStorage.setItem("ielts_answers", JSON.stringify({ ...(JSON.parse(localStorage.getItem("ielts_answers") || "{}")), reading: answers }));
    ...
    <main className="min-h-screen bg-white text-[#173E8C] p-6">
      <div className="max-w-3xl mx-auto">
        <div className="flex justify-between items-center mb-6">
          ...
          <Timer minutes={60} onFinish={submit} />
        </div>
        ...
        <div className="flex justify-end mt-6">
          <button onClick={submit} className="bg-[#173E8C] text-white px-4 py-2 rounded-xl">Submit & Continue → Writing</button>
        </div>
      </div>
    </main>
  );
