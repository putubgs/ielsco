        ...
        <div className="flex-1 min-w-0">
          ...
          {isLocked && (
            <div className="mt-4 pt-4 border-t border-gray-200">
              <button className="w-full py-3 px-4 bg-gradient-to-r from-[#E56668] to-[#ff8f91] text-white rounded-xl font-bold text-sm flex items-center justify-center gap-2 hover:shadow-lg transition-all">
                <Crown size={16} />
