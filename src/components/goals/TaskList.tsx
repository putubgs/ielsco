...
// 1. Tambahin import PricingModal
...
export default function TaskList({
  ...
  // 2. Tambahin state buat ngontrol Modal
  ...
  return (
    <>
        ...
        {userTier === "explorer" && stats.locked > 0 && (
          <div className="p-4 bg-gradient-to-r from-yellow-50 to-orange-50 border border-yellow-200 rounded-xl">
            <div className="flex items-start gap-3">
              ...
              {/* 3. Tambahin fungsi onClick di mari */}
              <button 
                onClick={() => setShowPricingModal(true)}
                className="px-4 py-2 bg-[#E56668] text-white rounded-lg text-xs font-bold hover:bg-[#C04C4E] active:scale-95 transition-all whitespace-nowrap"
              >
                Upgrade Now
              </button>
            </div>
      ...
      {/* 4. Render Pricing Modal di luar struktur list biar aman posisinya */}
      {showPricingModal && (
        <PricingModal 
