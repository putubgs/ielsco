...
export const partnerUpdatesData: PartnerUpdate[] = [
  {
    id: "1",
    title: "Partnership with Global Education Network",
    description:
  ...
  {
    id: "2",
    title: "Corporate Training Program Expansion",
    description:
  ...
  {
    id: "3",
    title: "IELS x Skilio: Remote Work Bootcamp Launch",
    description:
  ...
  {
    id: "5",
    title: "Tech Industry Collaboration Initiative",
    description:
  ...
  {
    id: "6",
    title: "IELS Global Ambassador Program",
    description:
